    ...
    <div class="container w-full max-w-none px-48">
        <header class="p-3 text-center border-b dark:border-neutral-500" v-if="isAuthenticated">
            <nav class="flex justify-center items-center space-x-3">
                ...
                <router-link v-if="appconfig.modules.morph ? appconfig.modules.morph.enabled : false" class="flex items-center text-gray-500 hover:text-gray-600 px-2" to="/morph"><img class="rounded-full w-6 h-6 mr-2" :src="'/morph-scan.png'" alt=""> Morph</router-link>
